...
def trigonometric_functions():
    ...
    if event in ["sin","cos","tan"]:
        ...
        var["y_val"] = format_number()
        clear_click()
        var["result"] = eval("math." + var['operator'] + "(" + str(var["y_val"]) + ")")
        var["issue"] = True
        update_display(var["result"]) 
        var["x_val"] = var["result"]
...
if __name__ == "__main__":
    ...
    layout = [[sg.Text("0.0000",key="_DISPLAY_",size=(30, 1))],
            [sg.Button("sin",key="sin",size=(3, 1)),sg.Button("cos",key="cos",size=(3, 1)),
             sg.Button("tan",key="tan",size=(3, 1)),sg.Button("CE",key="CE",size=(3, 1))],
    ...
    var = {"front":["0"],"back":["0"],"decimal":True,
        "x_val":0.0,"y_val":0.0,"result":0.0,"operator":"+","issue":False}
